...
description: Smart farming, future farming and smart agriculture with Pacificsoft IoT Platform
horizontaltoc: "true"
...
Pacificsoft platform provides out-of-the-box components and APIs to dramatically reduce time to market and your effort to develop smart farming solutions and projects.
...
The attached dashboard demonstrates real-time data from IoT sensors that is collected using Pacificsoft MQTT API. The data is stored in Cassandra DB on our demo server.
...
The diagram below identifies data flow and integration points for typical smart farming solution that uses Pacificsoft platform to collect and analyze smart farming data from IoT sensors.
