...
description: Pacificsoft IoT Platform sample for temperature data upload over MQTT using Raspberry Pi and DHT22 sensor.
...
Raspberry Pi push data to Pacificsoft server via MQTT protocol by using [paho mqtt](https://eclipse.org/paho/clients/python/) python library.
