...
description: Pacificsoft IoT Platform hardware samples for Raspberry Pi devices.
...
## Samples
 ...
 - [Raspberry Pi GPIO control over MQTT using Pacificsoft](/docs/samples/raspberry/gpio/)
 - [Raspberry Pi GPIO control using Android Things and Pacificsoft](/docs/samples/raspberry/gpio-android-things/)
