...
More details about Alarms in the Pacificsoft can be found in [this tutorial](/docs/user-guide/alarms/)
...
Transform incoming Message with configured JavaScript function to String and log final value into the Pacificsoft log file. 
...
For more details how RPC works in the Pacificsoft, please read [RPC capabilities](/docs/user-guide/rpc/) Article.
