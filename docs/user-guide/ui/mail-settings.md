...
- ashvayka
title: Mail Settings
description: Pacificsoft IoT platform mail settings

---

Pacificsoft System Administrator is able to configure a connection to a SMTP server that will be used to distribute activation and password reset emails to users.
...
Login to your Pacificsoft instance WEB UI as a system administrator using default [**account**](/docs/samples/demo-account/#system-administrator).
...
Once you populate the API key name and generate it, you will be able to copy-paste settings from the screen to Pacificsoft mail settings form.
