...
Pacificsoft allows subscribing to changes of shared device attributes from the device application. See [user guide](/docs/user-guide/attributes/) for more details.
