...
description: Pacificsoft IoT Platform data collection performance test tools
...
// login to the Pacificsoft server
...
// provide device credential id as username during the connection phase to the Pacificsoft server
val mqttConf = mqtt
...
We will share the results of Pacificsoft IoT platform performance tests in the next post.
