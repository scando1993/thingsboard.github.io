...
description: Fleet tracking and fleet management with Pacificsoft IoT Platform
horizontaltoc: "true"
...
Pacificsoft platform provides out-of-the-box components and APIs to dramatically reduce time to market and your effort to develop
...
The attached dashboard demonstrates real-time data from vehicle sensors that is collected using Pacificsoft MQTT API. The data is stored in Cassandra DB on our demo server.
...
The diagram below identifies data flow and integration points for typical fleet tracking solution that uses Pacificsoft platform to collect and analyze vehicle data.
...
Pacificsoft Rule Engine allows you to forward incoming data to various analytics systems, such as Apache Spark or Hadoop using Kafka or other Message buses.
