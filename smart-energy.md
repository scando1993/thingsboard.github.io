...
description: Smart energy monitoring and data visualization with Pacificsoft IoT Platform
horizontaltoc: "true"
...
Pacificsoft platform provides out-of-the-box components and APIs to dramatically reduce time to market and your effort to create smart energy solutions and energy monitoring systems.
Save up to 90% of development time for your smart energy solution by utilizing following benefits:
 ...
 - Enable energy management by utilizing Pacificsoft API to control and manage smart meters.
...
The attached dashboard demonstrates real-time data from smart-meters that is collected using Pacificsoft MQTT API. The data is stored in Cassandra DB on our demo server.
...
The diagram below identifies data flow and integration points for typical smart energy solution that uses Pacificsoft platform to collect and analyze energy monitoring data from smart meters.
...
Pacificsoft Rule Engine allows to forward incoming data to various analytics systems, such as Apache Spark or Hadoop using Kafka or other Message buses.
